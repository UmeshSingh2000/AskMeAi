        ...
        <Dialog>
            <form>
                ...
                <DialogContent className="sm:max-w-[425px]">
                    <DialogHeader>
                        <DialogTitle className="text-2xl font-bold">{isRegister ? "Register" : "Login"}</DialogTitle>
                    ...
                    <DialogFooter className="mt-4 flex justify-end gap-2">
                        ...
                        <Button onClick={handleFormSubmit}>{isRegister ? "Register" : "Login"}</Button>
                    </DialogFooter>
                </DialogContent>
            </form>
        </Dialog>
